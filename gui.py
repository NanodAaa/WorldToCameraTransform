...
class W2CTransform():
    ...
    def set_init_window(self):
        ...
        # Menu
        self.menu = tk.Menu(self.init_window_name)
        
        # Menu - Tools
        tools_menu = tk.Menu(self.menu, tearoff=False)
        tools_menu.add_command(label='Min Mag Factor')
        self.menu.add_cascade(label='Tools', menu=tools_menu)
        
        # Menu - Help
        help_menu = tk.Menu(self.menu, tearoff=False)
        help_menu.add_command(label='About', command=self.onclick_menu_button_about)
...
#        self.save_data_from_entry_to_memory()
    ...
    def show_about(self):
        self.about_window = tk.Toplevel(self.init_window_name)
